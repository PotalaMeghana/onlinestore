<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.List, eStoreProduct.model.admin.output.ProductShip" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<table>
    ...
    <tr>
        ...
        <th style="text-align: center; vertical-align: middle;">Shipping Charge</th>
